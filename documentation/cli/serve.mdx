...
Start the NiceGUI web interface. Provides a live debate view with WebSocket streaming, inline diff, a research dashboard with transcript browser and charts, and a config panel.
