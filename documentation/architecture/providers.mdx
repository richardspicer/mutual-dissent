...
The router maps model aliases and OpenRouter model IDs to vendors via their ID prefix (`anthropic/`, `openai/`, `google/`, `x-ai/`, `groq/`). Unknown prefixes fall back to `Vendor.OPENROUTER`.
